...
import com.ashish.util.ParseHttpHeader;

@Path("/v1/header")
public class V1_header {

	/**
	 * This resource is a example of how to look at the http header. You will
	 * need to bring in the hsr as a parameter
	 * 
	 * @param hsr
	 * @return
	 * @throws Exception
	...
	public Response returnAllPcParts(@Context HttpServletRequest hsr)
			throws Exception {
		...
		try {
			...
			// To see list of all properties
			//String browser = json.toString();
