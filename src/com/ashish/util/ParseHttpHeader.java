...
public class ParseHttpHeader {
	...
	/**
	 * This method will parse the http header and put it into a json object We
	 * are using json because the header content is quite dynamic in what
	...
	public static JSONObject parseHSR(HttpServletRequest hsr) throws Exception {
		...
		try {
			...
			while (headerNames.hasMoreElements()) {
				...
				// System.out.print("Header: " + headerName + " Value: " +
